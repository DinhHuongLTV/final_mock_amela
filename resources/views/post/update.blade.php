    ...
    <div class="col-md-8">
        ...
        <form method="POST" action="{{ route('update_post', $post->id) }}">
            ...
            <div class=" mb-3">
                ...
                <div class="col-12">
                    <input id="title" type="text" class="form-control @error('title') is-invalid @enderror" name="title" value="{{ old('title') ? old('title') : $post->title }}" autofocus placeholder="Tiêu đề ...">
                    @error('title')
            ...
            <div class="mb-3">
                ...
                <div class="col-12">
                    <textarea name="content" id="Content" style="width: 100%" rows="10" placeholder="Nội dung bài viết ... " class="form-control @error('content') is-invalid @enderror">{{ old('content') ? old('content') : $post->content }}</textarea>
                    @error('content')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
